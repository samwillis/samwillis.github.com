...
var Slimbox = (function() {
	...
	*/
	...
	function animateBox() {
		...
		fn = function() {
			bottomContainer.setStyles({width: '100%', top: -9999, marginLeft: -9999, display: "block"});
			bottomContainer.setStyles({width: 'auto', top: top + centerHeight - bottom.offsetHeight -16 , marginLeft: (centerWidth/2)-bottom.offsetWidth-23});
			fxImage.start(1);
		};
		if (check) {
			fxResize.chain(fn);
